      ...
      else
      {
        ids.forEach(function(idName)
        {
          if (userSnap.name() == idName || ids == undefined)
          {
            ...
            resultHtml = "<img src='images/eventpics/" + info.picture + "' width='60px' height='60px'>" + info.title + "<br/>";
			detailHtml = info.description; 
			$('#resultList').append('<li><a href="#">' + resultHtml + '<span class="st-arrow">Open or Close</span></a><div class="st-content ">'+ detailHtml  +'</div></li>'); 
